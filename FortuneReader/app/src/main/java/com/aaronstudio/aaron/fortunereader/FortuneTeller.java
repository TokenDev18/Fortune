...
/**
 * Created by aaron on 11/25/15.
 */
public class FortuneTeller implements TextToSpeech.OnInitListener {
    ...
    public String getFortune(String userFortune) {
        ...
        if (userFortune.toLowerCase().contains("how ") || userFortune.toLowerCase().contains(" how ")
                || userFortune.toLowerCase().equals("how") || userFortune.toLowerCase().equals("how's")) {
            return howResponses[random.nextInt((howResponses.length))];
                ...
                || userFortune.toLowerCase().equals("who") || userFortune.toLowerCase().equals("who's")) {
            ...
            return whenResponses[random.nextInt((whenResponses.length))];
                ...
                || userFortune.toLowerCase().equals("what") || userFortune.toLowerCase().equals("what's")) {
            return whatResponses[random.nextInt((whatResponses.length))];
                ...
                || userFortune.toLowerCase().equals("where") || userFortune.toLowerCase().equals("where's")) {
    ...
    public void textToSpeechTeller(String spokenText){
        ...
        if (spokenText.toLowerCase().contains("how ") || spokenText.toLowerCase().contains(" how ")
                || spokenText.toLowerCase().equals("how") || spokenText.toLowerCase().equals("how's")) {
            voiceResponse = howResponses[random.nextInt((howResponses.length))];
                ...
                || spokenText.toLowerCase().equals("who") || spokenText.toLowerCase().equals("who's")) {
            ...
            voiceResponse = whenResponses[random.nextInt((whenResponses.length))];
                ...
                || spokenText.toLowerCase().equals("what")  || spokenText.toLowerCase().equals("what's")) {
            voiceResponse = whatResponses[random.nextInt((whatResponses.length))];
                ...
                || spokenText.toLowerCase().equals("where") || spokenText.toLowerCase().equals("where's")) {
